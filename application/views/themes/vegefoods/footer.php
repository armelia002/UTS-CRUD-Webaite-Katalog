  ...
  <footer class="ftco-footer ftco-section">
    <div class="container">
      ...
      <div class="row mb-5">
        ...
        <div class="col-md-4">
           <div class="ftco-footer-widget mb-4">
            <h2 class="ftco-heading-2">Biodata</h2>
            <div class="d-flex">
                <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
                  <li><a href="<?php echo site_url('shop/cart'); ?>" class="py-2 d-block">Armelia Luvita Sari</a></li>
                  <li><a href="<?php echo site_url('customer/payments/confirm'); ?>" class="py-2 d-block">20312057</a></li>
                  <li><a href="<?php echo site_url('shop/testimonial'); ?>" class="py-2 d-block">email : armelialuvita@gmail.com</a></li>
                </ul>
              </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> |  Armelia Luvita.
